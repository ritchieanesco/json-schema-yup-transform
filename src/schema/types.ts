...
export const hasAnyOf = (value: JSONSchema): value is AnyOfSchema7 =>
  !!value.anyOf;

export const hasAllOf = (value: JSONSchema): value is AllOfSchema7 =>
  !!value.allOf;

export const hasOneOf = (value: JSONSchema): value is OneOfSchema7 =>
  !!value.oneOf;

export const hasNot = (value: JSONSchema): value is NotSchema7 => !!value.not;
