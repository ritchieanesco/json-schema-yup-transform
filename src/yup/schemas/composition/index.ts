...
export const createAnyOfSchema = (
  [key, value]: [string, JSONSchema7 & { anyOf: JSONSchema7Definition[] }],
...
export const createAllOfSchema = (
  [key, value]: [string, JSONSchema7 & { allOf: JSONSchema7Definition[] }],
  jsonSchema: JSONSchema7
): Yup.MixedSchema<string> => {
...
export const createOneOfSchema = (
  [key, value]: [string, JSONSchema7 & { oneOf: JSONSchema7Definition[] }],
  jsonSchema: JSONSchema7
): Yup.MixedSchema<string> => {
...
export const createNotSchema = (
  [key, value]: [string, JSONSchema7 & { not: JSONSchema7Definition }],
  jsonSchema: JSONSchema7
): Yup.MixedSchema<string> => {
